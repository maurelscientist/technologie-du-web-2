...
<body>
    ...
    <p><a class="btn" href="liste_etudiant.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="details-container">
        ...
        <div class="info-box">
            ...
            <br>
            <a class="btn" href="modifier_etudiant.php?id_etudiant=<?= urlencode($e['id']) ?>">Modifier informations
                étudiant</a>
        </div>
    </div>
